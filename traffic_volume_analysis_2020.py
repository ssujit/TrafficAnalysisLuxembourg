...
def line_chart(T, title, limit=40000, step=5000, route="A"):
    ...
    plt.title(title)
    plt.legend()
    plt.savefig("result/line_chart_traffic_analysis_"+T+"_"+route+"_2020.jpg")
    plt.show()
...
def bar_chart(T, title, route="A"):
    ...
    plt.show()
    plt.savefig("result/bar_chart_traffic_analysis_"+T+"_"+route+"_2020.jpg", dpi=600)
...
def stack_area_chart(T, title, limit=40000, step=5000, route="A"):
    ...
    plt.legend()
    plt.title(title)
    plt.savefig("result/stacked_chart_traffic_analysis_"+T+"_"+route+"_2020.jpg")
    plt.show()


# Read and prepare dataframe
test = pd.read_csv('data/twoway_cars_traffic_2020_complete.csv')
...
test.to_csv('data/twoway_cars_traffic_2020_complete_with_mor_evn.csv')
