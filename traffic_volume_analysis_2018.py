...
stack_area_chart(T="E", title="Luxembourg Traffic Volume in Evening Rush Hours 2018", limit=55000, step=5000)
stack_area_chart(T="M", title="Luxembourg Traffic Volume in Morning Rush Hours between Germany 2018", route="A1", limit=11000, step=1000)
stack_area_chart(T="E", title="Luxembourg Traffic Volume in Evening Rush Hours between Germany 2018", route="A1", limit=11000, step=1000)
stack_area_chart(T="M", title="Luxembourg Traffic Volume in Morning Rush Hours between France 2018", route="A3", limit=13000, step=1000)
stack_area_chart(T="E", title="Luxembourg Traffic Volume in Evening Rush Hours between France 2018", route="A3", limit=13000, step=1000)
stack_area_chart(T="M", title="Luxembourg Traffic Volume in Morning Rush Hours between Belgium 2018", route="A7", limit=5000, step=500)
stack_area_chart(T="E", title="Luxembourg Traffic Volume in Evening Rush Hours between Belgium 2018", route="A7", limit=5000, step=500)
